'use server';
/**
 * @fileOverview A flow to convert text to speech using Genkit's native TTS model.
 *
...
const textToSpeechFlow = ai.defineFlow(
  ...
  async ({ text }) => {
    ...
    // The audio is returned as PCM data in a data URI. We need to convert it to a WAV file to be playable in browsers.
